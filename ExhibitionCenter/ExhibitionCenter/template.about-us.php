...
<div class="inspiration-block-gallery">
    ...
    <div class="inspiration-block-gallery-photos">
        <div class="photo1-photo2">
            <div class="photo1">
                <a href="shop.php"><img src="img/photo4.png" alt="photo1"><p>Фото №1</p></a>
            </div>
            <div class="photo2">
                <a href="shop.php"><img src="img/photo2.png" alt="photo2"><p>Фото №2</p></a>
            </div> 
        </div> 
        <div class="photo3-photo4">
                <div class="photo3">
                <a href="shop.php"><img src="img/photo3.png" alt="photo3"><p>Фото №3</p></a>
                </div>    
                <div class="photo4">
                <a href="shop.php"><img src="img/preview1.png" alt="photo4"><p>Фото №4</p></a>
            </div>  
        </div>
    </div>
</div>
