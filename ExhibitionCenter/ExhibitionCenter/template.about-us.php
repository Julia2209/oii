...
<div class="inspiration-block-gallery">
    ...
    <div class="inspiration-block-gallery-photos">
        <div class="photo1-photo2">
            <div class="photo1">
                <a href="pictures.php"><img src="img/photo4.png" alt="photo1"><p>Анна Фикус<br />"Солнце над Землей"<br />Фото, пленка</p></a>
            </div>
            <div class="photo2">
                <a href="pictures.php"><img src="img/photo2.png" alt="photo2"><p>Анна Фикус<br />"Ромашки такие ромашки"<br />Фото, пленка</p></a>
            </div> 
        </div> 
        <div class="photo3-photo4">
                <div class="photo3">
                <a href="pictures.php"><img src="img/photo3.png" alt="photo3"><p>Мария Иванова<br />"Сельсткая история"<br />Акварель</p></a>
                </div>    
                <div class="photo4">
                <a href="pictures.php"><img src="img/preview1.png" alt="photo4"><p>Руслан Новиков<br />"Птица счастья завтрашнего дня"<br />Аппликация</p></a>
            </div>  
        </div>
    </div>
</div>
...
<div class="slider">
    <div class="slide-wrap">
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event1.png" alt="" />
            <span class="slide-title">Событие первое</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event2.png" alt="" />
            <span class="slide-title">Ну просто очень длинное название второго события</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event3.png" alt="" />
            <span class="slide-title">Название еще длинее, чем было предыдущее, красивая выставка!</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event4.png" alt="" />
            <span class="slide-title">Четвертый покал</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event5.png" alt="" />
            <span class="slide-title">Событие пять</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event6.png" alt="" />
            <span class="slide-title">Событие шесть</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event7.png" alt="" />
            <span class="slide-title">Событие семь</span></a>
        </div>
        <div class="slide-item">
            <a href="events.php"><img src="img/slider-event8.png" alt="" />
